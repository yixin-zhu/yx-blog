...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    //注入我们在yx-blog工程写的JwtAuthenticationTokenFilter过滤器
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.DELETE, "/content/tag/**").permitAll()
...
//                .antMatchers("/upload").authenticated()
        ...
        //把我们在yx-blog工程写的JwtAuthenticationTokenFilter过滤器添加到Security的过滤器链中
